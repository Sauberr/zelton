...
SECRET_KEY = "django-insecure-r4ko3ub!cadxj8gfm1tf##2re0+^0zjapw!vr7)dba7n^c8$yw"
...
JAZZMIN_SETTINGS: Dict[str, ...] = {
    ...
    "icons": {
        "core.Product": "fa fa-th",
        "core.Category": "fa fa-list",
        "core.ProductReview": "fa fa-star",
        "core.Wishlist": "fa fa-heart",
        "core.CartOrder": "fa fa-shopping-cart",
        "core.CartOrderProducts": "fa fa-shopping-cart",
        "userauths.User": "fa fa-user",
        "userauths.Profile": "fa fa-user",
        "core.Address": "fa fa-address-book",
        "core.Vendor": "fa fa-user",
    },
}

...
class AddProductForm(forms.ModelForm):
    ...
    mfg = forms.DateTimeField(
        widget=forms.DateTimeInput(attrs={'placeholder': "e.g: 22-11-02", "class": "form-control"}))
    ...
    class Meta:
        ...
        fields = ['title',
                  ...
                  'old_price', 'specifications',
                  'type', 'stock_count', 'life',
                  'mfg', 'tags', 'digital', 'category',]

...
class Vendor(models.Model):
    ...
    description = CKEditor5Field(
        config_name="extends", null=True, blank=True, default="I am an Amazing vendor"
    )
...
class Product(models.Model):
    ...
    description = CKEditor5Field(
        config_name="extends", null=True, blank=True, default="This is the product"
    )
    ...
    sku = ShortUUIDField(
        unique=True, length=5, max_length=10, prefix="sku", alphabet="12345678090"
    )
...
class ProductImages(models.Model):
    ...
    product = models.ForeignKey(
        Product, on_delete=models.SET_NULL, null=True, related_name="p_images"
    )
    date = models.DateTimeField(auto_now_add=True)
...
class CartOrder(models.Model):
    ...
    sku = ShortUUIDField(
        null=True, blank=True, length=5, prefix="sku", alphabet="12345678090"
    )
